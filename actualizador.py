...
APPS = [
    ...
    dict(name="kstuff-lite", repo="EchoStretch/kstuff-lite",
         match=["kstuff"], exclude=["debug"], category="GAMES",
         desc="Versión ligera de kstuff para PS5."),
    dict(name="ShadowMountPlus", repo="drakmor/ShadowMountPlus",
         match=["shadowmount"], archive=["shadowmount"], category="GAMES",
    ...
    dict(name="APR Emu Updater", repo="tsuramatsu1/apr-emu-updater",
         match=["apr_emu_updater"], category="GAMES",
    ...
    dict(name="Game Compressor", repo="juma-sayeh/PS5-Game-Compressor",
         match=["game-compressor"], category="GAMES",
    ...
    dict(name="PS5 App Dumper", repo="EchoStretch/ps5-app-dumper",
         match=["app", "dumper"], archive=["dumper"], category="GAMES",
    ...
    dict(name="Spectrum Library", repo="Phoenixx1202/Spectrum-Library",
         match=["spectrum"], archive=["spectrum"], category="STORES",
...
CAT_ORDER = {"SYSTEM": 0, "HEN": 1, "GAMES": 2, "TOOLS": 3, "STORES": 4}
...
def source_url(app):
    return app.get("source") or f'https://github.com/{app["repo"]}/releases'
...
def display_desc(desc, ch):
    prefix = {"stable": "RECOMENDADA", "beta": "BETA", "alpha": "ALPHA / TEST / INESTABLE"}[ch]
