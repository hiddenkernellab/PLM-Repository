# HK-HOTFIX-NEXGEN-RAW-CHECKSUM-2026-09-25
# HK-HOTFIX-FPKG-SOURCES-2026-09-25-V4
# HK-HOTFIX-NEXGEN-RAW-2026-09-25-V2
# HK-CATALOG-2026-09-25
#!/usr/bin/env python3
import hashlib
import io
import json
...
FIXED = [
    ...
    dict(
        ...
        filename="kstuff-lite_v1.12-fpkg-dr-test8.elf",
        local_path="payloads/fpkg-tests/kstuff.elf",
        expected_checksum="fafee1a13933e4a783e3438d7b3d10478e8dfd6f29e6e432a7a2a711650d81a4",
        required=True,
        source="Discord de Drakmor (fpkg-test-reports-only)",
        version="1.12-fpkg-dr-test8",
        date="2026-09-15",
        channel="alpha",
        category="FPKG LEGACY",
        status="PRUEBA FPKG",
    ...
    dict(
        ...
        filename="shadowmountplus_v1.7alpha13fix1-13-g072c17.elf",
        local_path="payloads/fpkg-tests/shadowmountplus.elf",
        expected_checksum="03688cd6c361b22c07aa8c72314dcb3573b7e83b104634a9e99697de784eb760",
        required=True,
        source="Discord de Drakmor (fpkg-test-reports-only)",
        version="1.7alpha13fix1-13-g072c17",
        date="2026-09-15",
        channel="alpha",
        category="FPKG LEGACY",
        status="PRUEBA FPKG",
    ...
    dict(
        ...
        expected_checksum="bf641bf7b3502ceeb1853d36c6aaad7ef501a0d1af931fc3f013eebe08908ebc",
        required=True,
        source="Discord de Drakmor (fpkg-test-reports-only)",
        version="15.09-bf641bf7",
        date="2026-09-15",
        channel="alpha",
        category="FPKG LEGACY",
...
CAT_ORDER = {"ESENCIALES": 0, "HEN / AIO": 1, "SISTEMA": 2, "ARCHIVOS / PC": 3, "PKG / INSTALACION": 4, "JUEGOS / COMPATIBILIDAD": 5, "UTILIDADES": 6, "MANDOS": 7, "DESCARGAS": 8, "FPKG INTEGRADO": 9, "FPKG MODULAR": 10, "FPKG LEGACY": 11, "ALTERNATIVOS": 12}
